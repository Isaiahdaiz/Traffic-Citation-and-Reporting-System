...
public class ModifyVehicleController {
    ...
    @FXML
    private RadioButton unregisteredRadioButton;

    @FXML
    private RadioButton stolenRadioButton;

    @FXML
    private RadioButton notStolenRadioButton;

    @FXML
    private RadioButton warrantsYesRadioButton;

    @FXML
    private RadioButton warrantsNoRadioButton;
    ...
    public void initialize(String currVIN) {
        ...
        try {
            ...
            //yearTextField.setText(Integer.toString(vehicle.getYear()));
    ...
    private void handleApplyButton() throws SQLException {
        ...
        // vehicle.setAvailability(getAvailability());
    ...
    private boolean validSubmission() {
        ...
        // You can add validations for the text fields here, similar to
        // ModifyCitationController.
        // I've left it empty as it depends on the specific validation requirements for
        // your application.
    ...
    private void setEditableAll(boolean editable) {
        ...
        //vinTextField.setEditable(editable);
        ...
        //colorTextField.setStyle(editable ? defaultEntryStyle : uneditableEntryStyle);
        //colorTextField.setEditable(editable);
