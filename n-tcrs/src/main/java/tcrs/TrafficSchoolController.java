...
public class TrafficSchoolController {
    ...
    @FXML
    private DatePicker sessionDatePicker0;

    @FXML
    private TextField sessionDurationTextField0;

    @FXML
    private Label sessionErrorLabel0;

    @FXML
    private HBox sessionHBox1;

    @FXML
    private DatePicker sessionDatePicker1;

    @FXML
    private Button sessionAddButton1;

    @FXML
    private TextField sessionDurationTextField1;

    @FXML
    private Label sessionErrorLabel1;

    @FXML
    private HBox sessionHBox2;

    @FXML
    private DatePicker sessionDatePicker2;

    @FXML
    private TextField sessionDurationTextField2;

    @FXML
    private Label sessionErrorLabel2;

    @FXML
    private Button sessionAddButton2;

    @FXML
    private TextArea reportNotes;
