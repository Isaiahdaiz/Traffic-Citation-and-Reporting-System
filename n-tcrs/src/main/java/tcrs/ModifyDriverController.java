...
public class ModifyDriverController {
    ...
    @FXML
    private TextArea drivingRecordTextArea;

    @FXML
    private RadioButton licenseActiveRadioButton;

    @FXML
    private RadioButton licenseNotActiveRadioButton;

    @FXML
    private RadioButton licenseSuspendedRadioButton;
