...
public class Citation {
    ...
    public static Citation searchCitation(int citationID) throws SQLException {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password)) {
            // Create a PreparedStatement to search for the citation with the given citation
            // ID
            ...
            // If a citation was found, create a Citation object and set its fields to the
